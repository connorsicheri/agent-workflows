...
**Use the right block, and make it carry substance.** Use the block patterns in
the bundled visual-plan and visual-recap references. Do not fetch a live block
catalog by default:
